...
@media(max-width:768px){
  header, .main-header{padding:10px 14px!important;flex-direction:column!important;gap:8px!important}
  header>div:first-child, .main-header>div:first-child{width:100%;justify-content:center!important}
  header>div:last-child, .main-header>div:last-child{width:100%;justify-content:center!important;flex-wrap:wrap!important;gap:4px!important}
  header>div:last-child>div, .main-header>div:last-child>div{padding:10px 10px!important;font-size:10px!important;flex:1!important;text-align:center!important;min-width:0!important}
  /* Guide tab buttons */
  button{min-height:44px!important}
  /* Prevent horizontal overflow */
  body{overflow-x:hidden!important}
  div[style*="maxWidth"]{padding-left:14px!important;padding-right:14px!important}
  /* Better touch targets */
  .card{padding:16px!important;margin-bottom:8px}
  /* Guide internal flex rows */
  div[style*="display: flex"][style*="gap: 16"]{flex-wrap:wrap!important}
  div[style*="display: flex"][style*="gap: 14"]{flex-wrap:wrap!important}
}
@media(max-width:480px){
  header>div:last-child>div, .main-header>div:last-child>div{padding:10px 6px!important;font-size:9px!important;letter-spacing:0.5px!important}
}
`}</style>;}
...
export default function App(){
  ...
  return <><Styles/>
    <div style={{minHeight:"100vh",background:"var(--bg)",paddingBottom:40}}>
      ...
      {/* Header */}
      <header className="main-header" style={{position:"sticky",top:0,zIndex:100,background:"#06060cee",borderBottom:"1px solid var(--brd)",padding:"12px 20px",display:"flex",justifyContent:"space-between",alignItems:"center",backdropFilter:"blur(12px)"}}>
